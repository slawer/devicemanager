...
{
    /// <summary>
    /// Реализует формулу по которой вычислять параметр
    /// </summary>
    public class Formula
    {
        protected long position = -1;               // позиция для сохранения вычисленного значения
        protected IMacros macros = null;            // реализует вычисление параметра

        protected ReaderWriterLock locker = null;   // синхронизирует доступ к данным класса
        protected long actual = 1;                  // актуалена формула или нет
        ...
        /// <summary>
        /// Определяет позицию сохранения вычисленного значения
        /// </summary>
        public int Position
        {
            get { return (int)Interlocked.Read(ref position); }
            set { Interlocked.Exchange(ref position, (long)value); }
        }
        ...
        {            
            get { return macros.Type; }
        }

        /// <summary>
        /// Определяет макрос вычисляющий значение параметра
        /// </summary>
        public IMacros Macros
        {
            get 
            {
                try
        ...
        /// <summary>
        /// Определяет формула актуальна или нет
        /// </summary>
