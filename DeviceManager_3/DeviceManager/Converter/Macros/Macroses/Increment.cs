...
{
    /// <summary>
    /// Реализует приращение параметра
    /// </summary>
    public class Increment : IMacros
    {
        /// <summary>
        ...
        protected string desc = string.Empty;           // описание функции
        ...
        {
            get { return FormulaType.Increment; }
        }
        ...
        public string Arguments
        {
            get
            {
                try
                {
                    return string.Format("Приращение(Пар.№{0})", arguments[0].Index);
                }
                catch
                {
        ...
        public string Name 
        {
            get { return "Приращение параметра"; }
        }
