...
{
    /// <summary>
    /// Реализует минимальное значение параметра
    /// </summary>
    public class Minimum : IMacros
    {
        /// <summary>
        ...
        protected float minimum = float.NaN;            // минимальное значение
        ...
        {
            get { return FormulaType.Minimum; }
        }
        ...
        public string Arguments
        {
            get
            {
                try
                {
                    return string.Format("Минимум(Пар.№{0})", arguments[0].Index);
                }
                catch
                {
        ...
        public string Name
        {
            get { return "Минимальное значение"; }
        }
