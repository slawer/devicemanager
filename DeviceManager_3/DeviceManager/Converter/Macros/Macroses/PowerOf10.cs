...
{
    /// <summary>
    /// Реализует функцию 10 в степени X
    /// </summary>
    public class PowerOf10 : IMacros
    {
        /// <summary>
        ...
        {
            get { return FormulaType.PowerOf10; }
        }
        ...
        public string Arguments 
        {
            get
            {
                try
                {
                    return string.Format("10 в степени(Пар.№{0})", arguments[0].Index);
                }
                catch
                {
