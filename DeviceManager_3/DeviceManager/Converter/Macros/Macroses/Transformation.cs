...
namespace DeviceManager
{
    ...
    /// </summary>
    public class Transformation : IMacros
    {
        /// <summary>
        ...
        /// </summary>
        public Argument[] Args { get { return arguments; } }
        ...
        public string Arguments 
        {
            get
            {
                try
                {
                    return string.Format("Кусочно-линейное преобразование(Пар.№{0})", arguments[0].Index);
                }
                catch
                {
