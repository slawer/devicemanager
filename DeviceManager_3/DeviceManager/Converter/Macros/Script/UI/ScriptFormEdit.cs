...
{
    public partial class ScriptFormEdit : Form
    {
        ...
        /// </summary>
        public ScriptFormEdit(Script script)
        {
            InitializeComponent();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            if (_script != null)
            {
                editor.Text = _script.ScriptCode;

                textBoxClass.Text = _script.ClassName;
                textBoxNamespace.Text = _script.Namespace;

                string[] asses = _script.Assemblies.ToArray();
                if (asses != null)
                {
