...
{
    /// <summary>
    /// Реализует преобразование пакетов по протоколу Dsn
    /// </summary>
    public static class PacketTranslater
    {
        ...
        public static byte[] TranslateToUnigueFormatTcpPacket(string packet, TypeCRC typeCRC)
        {
            ...
            switch (typeCRC)
            {
                case TypeCRC.Cycled:
                    ...
                    pack[pack.Length - 1] = (byte)CalculateOneByteCRC(pack);
                    break;
        ...
        public static ushort CalculateOneByteCRC(byte[] packet)
        {
            ushort crc = 0x0000;
        ...
        /// <param name="packet">Пакет</param>
        /// <returns>CRC для данного пакета</returns>
        public static ushort CalculateTwoByteCRC(byte[] packet)
        {
            ushort crc = 0x0000;
        ...
        /// <param name="packet">Пакет</param>
        /// <returns>CRC для данного пакета</returns>
        public static ushort CalculateTwoByteCRC16(byte[] packet)
        {
            ushort crc = 0xffff;
            for (int i = 1; i < packet.Length - 2; i++)
            {
