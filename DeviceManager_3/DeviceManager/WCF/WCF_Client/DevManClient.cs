...
namespace WCF.WCF_Client
{
    ...
    public class DevManClient : ICallBack
    {
        ...
        /// <summary>
        /// Передать пользователю команду TCP
        /// </summary>
        /// <param name="Packcet"></param>
        public void SendCom(String Packcet)
        {
        }
    ...
    public class ReceivedEventArgs : EventArgs
    {
        ...
        protected String tcp;                   // TCP пакет
        ...
        /// Инициализирует новый экземпляр класса
        /// </summary>
        /// <param name="packet">Передаваемый пакет пользователю</param>
        public ReceivedEventArgs(String packet)
            : base()
        {
            tcp = packet;
        }
