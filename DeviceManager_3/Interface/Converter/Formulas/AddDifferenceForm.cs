...
{
    public partial class AddDifferenceForm : Form
    {
        ...
        public AddDifferenceForm(Application _app)
        {
            app = _app;
            InitializeComponent();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void AddDifferenceForm_Load(object sender, EventArgs e)
        {
            tempIndex = Number;
        ...
        private void InsertSecond(Argument argument)
        {
            switch (argument.Source)
            {
                case DataSource.Signals:
                    ...
                    Formula formulaF = GetArgument(second);
                    if (formulaF != null)
                    {
                        listView1.Items[1].SubItems[2].Text = formulaF.Macros.Description;
                    }                     
                ...
                case DataSource.Results:
                    ...
                    Formula formulaS = GetArgument(second);
                    if (formulaS != null)
                    {
                        listView1.Items[1].SubItems[2].Text = formulaS.Macros.Description;
                    }
