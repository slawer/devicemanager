...
{
    /// <summary>
    /// Реализует добавление формулы вычитание
    /// </summary>
    public partial class AddDifferenceNewForm : Form
    {
        ...
        public AddDifferenceNewForm(Application _app)
        {
            app = _app;
            InitializeComponent();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void AddDifferenceNewForm_Load(object sender, EventArgs e)
        {
            tempIndex = Number;
        ...
        private void InsertSecond(Argument argument)
        {
            switch (argument.Source)
            {
                case DataSource.Results:
                    ...
                    if (formulaS != null)
                    {
                        listView1.Items[1].SubItems[1].Text = formulaS.Macros.Description;
                    }
