...
{
    public partial class AddMultiplicationNewForm : Form
    {
        ...
        public AddMultiplicationNewForm(Application _app)
        {
            app = _app;
            InitializeComponent();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void AddMultiplicationForm_Load(object sender, EventArgs e)
        {
            tempIndex = Number;
