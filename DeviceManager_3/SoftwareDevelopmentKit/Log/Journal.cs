...
namespace SoftwareDevelopmentKit.Log
{
    /// <summary>
    ...
    public class Journal
    {
        ...
        private const string sourceName = "logger";         // Имя источника, регистрируемого в журнале и используемого при записи в журнал событий  
        ...
        protected Journal()
        {
            ...
            if (!find)
            {
                EventLog.CreateEventSource(sourceName, "DeviceManager");
            }
